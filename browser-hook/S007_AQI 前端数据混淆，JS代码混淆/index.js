...
(async () => {
  var pKmSFk8 = poPBVxzNuafY8Yu('GETMONTHDATA',
    { city: '北京' }
  );
  ...
  const response = await axios.post(
    ...
    }),
    {
      headers: {
        ...
        'Cookie': 'Hm_lvt_6088e7f72f5a363447d4bafe03026db8=1719805380; Hm_lpvt_6088e7f72f5a363447d4bafe03026db8=1719812661',
  ...
  var data = dxvERkeEvHbS(response.data);
  var result = JSON.parse(data).result.data;

  fs.writeFileSync('./data1.json', JSON.stringify(result, null, 2));
})();